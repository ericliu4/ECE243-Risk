...
# Files
HDRS		:=
SRCS		:= src/draw.c src/draw.h src/enums.h src/game.c src/game.h src/globals.h src/helper.c src/helper.h src/main.c src/mouse.c src/mouse.h src/structs.h amp/lib/src/niosII_jtag_uart.c
...
# Files
SYS_FILE_SOF			:= "C:/intelFPGA_lite/23.1std/University_Program/Computer_Systems/DE10-Lite/DE10-Lite_Computer/verilog/DE10_Lite_Computer.sof"
